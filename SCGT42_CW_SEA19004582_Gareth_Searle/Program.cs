...
namespace TWW
{
    ...
    class program
    {
        static void Main()
        {
            ...
            //    //string[] accountdetails = { accountitems[0], accountitems[1], accountitems[2], accountitems[3] };
            ...
            //  //  string[] productdetails = { productitems[0],productitems[1], productitems[2], productitems[3] };
